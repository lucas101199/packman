...
public class GraphicEngine extends Application {
     ...
     * @throws Exception if the scene with the given {@code sceneLabel} is not found
     */
    public void setPositionButton(String sceneLabel, String buttonLabel, double x, double y) throws Exception {
        Scene scene = getScene(sceneLabel);
        if (scene != null) {
     ...
     * @throws Exception if the scene with the given {@code sceneLabel} is not found
     */
    public void resizeButton(String sceneLabel, String buttonLabel, double height, double width) throws Exception {
        Scene scene = getScene(sceneLabel);
        if (scene != null) {
     ...
     * @throws Exception if the scene with the given {@code sceneLabel} is not found
     */
    public void displayObject(String sceneLabel, String imageLabel) throws Exception {
        Scene scene = getScene(sceneLabel);
        if (scene != null) {
